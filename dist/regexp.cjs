...
exports.rAmount = rAmount;
exports.rBankCardNO = rBankCardNO;
exports.rChinese = rChinese;
exports.rChineseName = rChineseName;
exports.rEmail = rEmail;
exports.rEmoji = rEmoji;
exports.rHttp = rHttp;
exports.rHttps = rHttps;
exports.rIDCardNO = rIDCardNO;
exports.rIOSDateStringFormat = rIOSDateStringFormat;
exports.rInteger = rInteger;
exports.rMobilePhone = rMobilePhone;
exports.rPhone = rPhone;
exports.rPostcode = rPostcode;
exports.rTelephone = rTelephone;
exports.rUrl = rUrl;
