...
const a = ["角", "分"], s = ["零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖"], p = ["", "拾", "佰", "仟"], f = ["", "万", "亿"], m = /零[拾佰仟]/g, u = /零+([万亿])/g, d = /零{2,}/, $ = (l) => {
  l = g(l);
  let c;
  const t = l.toString().replace(/\.\d+$/, "").split(""), i = l.toString().replace(/^\d+\.?/, "").split("");
  for (let e = t.length - 1, n = 0; e >= 0; e--, n++)
    t[e] === "0" && e > 0 && e < t.length - 1 ? t[e] = "零" : t[e] = s[t[e]] + p[n % 4], t[e] += n % 4 === 0 ? f[n / 4] : "";
  for (let e = 0; e < i.length; e++)
    i[e] !== "0" ? i[e] = s[i[e]] + a[e] : i[e] = "";
